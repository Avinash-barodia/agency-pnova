  ...
  return (
    <section className="py-16 md:py-24 px-6 md:px-12 lg:px-[80px] text-center relative overflow-hidden bg-[var(--color-background)]">
      <div className="max-w-3xl mx-auto z-10 relative">
        <h2 className="font-serif text-[36px] md:text-[40px] lg:text-[48px] font-bold mb-8 md:mb-10 leading-tight md:leading-[56px]">Ready to build your digital empire?</h2>
