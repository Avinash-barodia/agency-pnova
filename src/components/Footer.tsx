...
export function Footer() {
  return (
    <footer className="w-full py-8 md:py-12 bg-[var(--color-background)] border-t border-[var(--color-surface-container-highest)]">
      <div className="flex flex-col items-center gap-8 md:gap-12 px-6 md:px-12 lg:px-[80px] max-w-[1440px] mx-auto">
