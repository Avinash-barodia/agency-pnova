...
export default function PuneVoicesCaseStudy() {
  useEffect(() => {
    ...
    progressContainer.style.background = 'linear-gradient(to right, #C9A84C, #f2ca50)';
  ...
  return (
    <main className="font-sans text-white selection:bg-[#C9A84C] selection:text-black bg-[#0A0A0A]">
      <NavBar />
      ...
      <header className="relative pt-32 pb-16 md:pt-48 md:pb-24 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <div className="reveal-up reveal-active max-w-3xl">
            <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 md:mb-6">CASE STUDY</p>
      ...
      <section className="py-16 md:py-32">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-start reveal-up">
            <div>
              <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 md:mb-6">01 · OVERVIEW</p>
      ...
      <section className="py-16 md:py-32 bg-[#080808] border-y border-white/5">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 text-center md:text-left">02 · CHALLENGE</p>
      ...
      <section className="py-16 md:py-32">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <div className="mb-12 md:mb-24 reveal-up">
            <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4">03 · STRATEGY</p>
          ...
          <div className="max-w-3xl reveal-up">
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Find Niche</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Build Brand</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Grow Audience</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6 border-transparent">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Build Host</h3>
      ...
      <section className="py-16 md:py-32 bg-[#080808] border-y border-white/5">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-3xl mx-auto w-full text-center">
          <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-6 md:mb-12">04 · BUSINESS IMPACT</p>
          ...
          <div className="bg-[#0A0A0A] border border-white/5 rounded-none p-6 md:p-16 relative overflow-hidden reveal-up w-full">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="flex flex-col items-center">
                <img alt="Rohit Kulkarni" className="w-16 h-16 object-cover rounded-full mb-4 border border-[#C9A84C]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCHixsZPZu42hSX1Qq30YjdtNCuAzyK1gS6HsaCvyYo8HXgK2tKLGoH0qHbICGsFlUbZAVQYHcHC15SwtFfMp0E7WMOthWJ56xN6JOeWViXskQioI4_HC_M_8XkVnQo4Ujzo9Xa3UrnECSP2Er8i3BleL3hffwXoorBuHTh0AciHGo5MAQpxY8fCpsdfWnInG-kDh10oSQy4xcupai8s2kmbMioWO50KP0DN5hfuJnC76d_h9G6OzuzBdVael8RLZNBhQ3ffalUwHE" />
                <p className="font-sans font-bold text-[16px] text-white">Rohit Kulkarni</p>
                <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mt-1">Founder & Host, Pune Voices</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Footer Navigation */}
      <nav className="border-y border-white/5 py-16 bg-[#0A0A0A]">
      ...
      <section className="py-24 md:py-40 relative overflow-hidden border-t border-white/5 text-center">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-[#C9A84C]/10 rounded-full blur-[80px] md:blur-[120px] pointer-events-none"></div>
        </div>
