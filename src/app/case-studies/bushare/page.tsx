  ...
  return (
    <main className="font-sans text-white selection:bg-[#C9A84C] selection:text-black bg-[#0A0A0A]">
      ...
      <section className="py-16 md:py-32">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24 items-start reveal-up">
            <div>
              <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 md:mb-6">01 · THE BRAND</p>
      ...
      <section className="py-16 md:py-32 bg-[#080808] border-y border-white/5">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 text-center md:text-left">02 · THE PROBLEM</p>
      ...
      <section className="py-16 md:py-32">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <div className="mb-12 md:mb-24 reveal-up">
            <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4">03 · WHAT WE DID</p>
          ...
          <div className="max-w-3xl reveal-up">
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Months 1–2</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Months 3–5</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Months 4–8</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Months 6–14</h3>
            ...
            <div className="border-b border-white/10 pb-6 mb-6 border-transparent">
              <h3 className="font-sans font-bold text-[18px] text-white mb-2 uppercase tracking-wide"><span className="text-[#C9A84C] mr-3">●</span> Throughout</h3>
      ...
      <section className="py-16 md:py-32 bg-[#080808] border-y border-white/5">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-[1440px] mx-auto w-full">
          <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-4 text-center">04 · THE RESULTS</p>
      ...
      <section className="py-16 md:py-32">
        <div className="px-5 md:px-[80px] max-w-none md:max-w-3xl mx-auto w-full text-center">
          <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mb-6 md:mb-12">05 · THE SHIFT</p>
          ...
          <div className="bg-[#0A0A0A] border border-white/5 rounded-none p-6 md:p-16 relative overflow-hidden reveal-up w-full">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <div className="flex flex-col items-center">
                <div className="w-12 h-px bg-[#C9A84C] mb-4"></div>
                <p className="font-sans font-bold text-[16px] text-white">Founder</p>
                <p className="font-sans text-[10px] tracking-[0.2em] text-[#C9A84C] uppercase mt-1">Bushare</p>
              </div>
            </div>
          </div>
        </div>
